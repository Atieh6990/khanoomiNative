...
import {
  View, BackHandler, Platform, Linking, PermissionsAndroid, StyleSheet, I18nManager,
} from "react-native";
...
const App = () => {
  ...
  useEffect(() => {
    ...
    //   setFullScreenVideo({
    //     position: "absolute", width: "82%", height: "100%", right: 0, top: 0,
    //   });
    // } else {
    //   setFullScreenVideo({
    //     position: "absolute", width: "82%", height: "100%", left: 0, top: 0,
    //   });
    // }
  ...
  const renderWebview = () => {
    return (
      ...
      <WebView
        ...
        source={{
          uri: "file:///android_asset/index.html?mac_lan=" + macLan + "&version=" + DeviceInfo.getSystemVersion() + "&mac=" + macAddress + "&uid=" + uid + "&tv_type=" + tvType + "&t=" + new Date().getTime(),
        }}
